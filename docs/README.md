...
| [`requisitos-sistema.md`](requisitos-sistema.md) | Qué computadora hace falta, con el porqué de cada número | Al cotizar, y antes de ir a instalar. Alimenta el Anexo A del contrato. |
